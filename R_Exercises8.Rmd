...
=
**myfaves<- c("Rice", "Fishcurry", "Meatcurry")
 myfaves
 "Rice", "Fishcurry", "Meatcurry"**
...
my.model <- lm(circumference ~ 1 + age, data = Orange) summary(my.model)
Call: lm(formula = circumference ~ 1 + age, data = Orange)
Residuals: Min 1Q Median 3Q Max -46.310 -14.946 -0.076 19.697 45.111
Coefficients: Estimate Std. Error t value Pr(>|t|)
(Intercept) 17.399650 8.622660 2.018 0.0518 .
age 0.106770 0.008277 12.900 1.93e-14 *** — Signif. codes: 0 ‘’ 0.001 ‘’ 0.01 ‘’ 0.05 ‘.’ 0.1 ‘ ’ 1
Residual standard error: 23.74 on 33 degrees of freedom Multiple R-squared: 0.8345,
Adjusted R-squared: 0.8295 F-statistic: 166.4 on 1 and 33 DF, p-value: 1.931e-14
...
author:
  - name: "Ananya"
    url: https://github.com/sarkerananya409
    affiliation: RStudio
